...
!(function (t, e) {
  ...
  class Ue extends W {
    ...
    _showElement(t) {
      ...
      e && (e.scrollTop = 0), g(this._element), this._element.classList.add(Ve);
      this._queueCallback(
        () => {
  ...
  class gi extends W {
    ...
    show(t) {
      ...
      if (j.trigger(this._element, ni, { relatedTarget: t }).defaultPrevented)
        return;
      (this._isShown = !0),
        this._backdrop.show(),
  ...
  class fs extends W {
    ...
    _activate(t, e) {
      if (!t) return;
      t.classList.add(ls), this._activate(K.getElementFromSelector(t));
      this._queueCallback(
        () => {
  ...
  class Os extends W {
    ...
    hide() {
      ...
      if (j.trigger(this._element, ws).defaultPrevented) return;
